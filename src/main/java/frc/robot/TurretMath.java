...
public class TurretMath {
    ...
    // Outputs
    public double turretAngle = 0; // Degrees (FIELD RELATIVE)
    ...
    public void calculate3DTurretMath(double robot_x /*meters, FIELD REL*/, double robot_y /*meters, FIELD REL*/, double robot_angle /*radians, FIELD REL*/, 
        double robotVel_x /*meters per second, ROBOT REL*/, double robotVel_y /*meters per second, ROBOT REL*/, double robotVel_angle /*radians per second, ROBOT REL*/) {
